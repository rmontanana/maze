...
def build_maze() -> Maze:
    return Maze(
        squares=(
            ...
            Square(index=242, row=14, column=4, border=Border.TOP | Border.BOTTOM, role=Role.EXIT),
            Square(index=243, row=14, column=5, border=Border.TOP),
            Square(index=244, row=14, column=6, border=Border.TOP | Border.BOTTOM, role=Role.ENEMY),
            ...
            Square(index=250, row=14, column=12, border=Border.TOP | Border.BOTTOM, role=Role.REWARD),
